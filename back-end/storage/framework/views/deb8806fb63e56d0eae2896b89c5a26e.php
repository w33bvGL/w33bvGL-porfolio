...
<div class="container">
    ...
    <div class="left">
        <h1><?php echo e($name ?? 'vahesargsyan'); ?></h1>
        <h2><?php echo e($role ?? 'Developer'); ?></h2>
        <p><?php echo e($email ?? 'example@example.com'); ?></p>
    </div>

    <div class="right">
        <img src="<?php echo e($imageUrl ?? 'https://via.placeholder.com/300'); ?>" alt="Profile Image">
    </div>
</div>
</body>
</html>
