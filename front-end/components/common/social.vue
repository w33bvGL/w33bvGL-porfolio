...
const socialNetworks = ref<Array<{ id: number, native_name: string, name: string, icon: string, link: string }>>([]);

const { data } = await useAsyncData("social", () => $fetch("/api/social/get-all", { method: 'GET' }));
