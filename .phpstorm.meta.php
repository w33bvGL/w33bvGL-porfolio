...
'livewire.update','livewire.upload-file','livewire.preview-file','dashboard','profile','storage.local',);
        registerArgumentsSet('views', 
'app','components.common.back-to-top','components.common.cursor','errors.401','errors.402',
'errors.403','errors.404','errors.419','errors.429','errors.500',
'errors.503','errors.layout','errors.minimal','layouts.default','pages.welcome',
'volt-livewire::app','volt-livewire::components.common.back-to-top','volt-livewire::components.common.cursor','volt-livewire::errors.401','volt-livewire::errors.402',
'volt-livewire::errors.403','volt-livewire::errors.404','volt-livewire::errors.419','volt-livewire::errors.429','volt-livewire::errors.500',
'volt-livewire::errors.503','volt-livewire::errors.layout','volt-livewire::errors.minimal','volt-livewire::layouts.default','volt-livewire::pages.welcome',
